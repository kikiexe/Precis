...
>
  ...
  >
    <div
      class="mb-5 inline-flex size-12 items-center justify-center rounded-2xl bg-[#17171c] text-lg font-bold text-white shadow-xs"
    >
      P
    </div>
    ...
    {:else if successMessage}
      <div
        class="mx-auto mb-4 flex size-12 items-center justify-center rounded-2xl border border-[#a7f3d0] bg-[#ecfdf5] text-[#059669]"
      >
    ...
    {:else}
      <div
        class="mx-auto mb-4 flex size-12 items-center justify-center rounded-2xl border border-[#fecaca] bg-[#fef2f2] text-[#dc2626]"
      >
