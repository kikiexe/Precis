  ...
  <div class="flex-1 space-y-4 overflow-y-auto p-4 sm:p-6 lg:p-8">
    <div class="mx-auto w-full max-w-7xl space-y-4">
      ...
      {#if activeSession && activeSession.status === 'OPEN'}
        ...
        >
          <div class="flex items-start gap-3">
            <div
              class="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-xl border border-amber-200 bg-amber-100 text-amber-800"
            >
      ...
      {#if filteredClosedSessions.length === 0}
        ...
        >
          <History class="mx-auto mb-2 size-10 text-zinc-400 opacity-30" />
